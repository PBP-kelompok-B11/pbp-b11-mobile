...
class _ClubDetailAdminState extends State<ClubDetailAdmin> {
  ...
  // Flag untuk mendeteksi apakah data sudah pernah diubah di halaman ini
  ...
  // Helper untuk refresh data lokal di halaman detail
  void _refreshData() {
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: false, // Kita handle manual untuk mengirim data balik
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) return;
        // Kirim _isEdited kembali ke halaman list agar list tau harus refresh atau tidak
        Navigator.pop(context, _isEdited || result == true);
      },
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              // Menutup halaman dengan membawa status _isEdited
